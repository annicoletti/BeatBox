    ...
    */
    ...
    public class MySendListener implements ActionListener{
        public void actionPerformed (ActionEvent a){
            /**
             * Tudo acontecerá quandoo o usuário clicar no botão e o ActionEvent
             * for acionado
             */

            boolean[] checkboxState = new boolean[256];
            /**
             * Cria uma matriz boleana para armazenar o estado da caixa de seleção.
             * Percorre checkboxList (ArrayList de caixas de seleção), captura o
             * estado de cada caixa de seleção e o adiciona a matriz booleana.
             */
            for (int i=0; i<256; i++){
            ...
            try{
                ...
                FileOutputStream fileStream = new FileOutputStream(new File(fc.getSelectedFile().getPath()));
    ...
    public class MyReadListener implements ActionListener{
        public void actionPerformed (ActionEvent e){
            ...
            try{
                ...
                FileInputStream fileIn = new FileInputStream(new File(fc.getSelectedFile().getPath()));
                ObjectInputStream is = new ObjectInputStream(fileIn);
                
                /**
                 * Lê o único objeto do arquivo(a matriz booleana) e o converte 
                 * novamente em uma matriz booleana. [lembre-se de que o ReadObject()
                 * retorna uma referencia do tipo Object].
                 */
            ...
            /**
             * Agora restaurará o estado de cada caixa de seleção da ArrayList 
             * de objetos JCheckBox (checkboxList).
             */
            for(int i=0; i<256; i++){
                JCheckBox check = (JCheckBox) checkBoxList.get(i);
                if(checkboxState[i]){
